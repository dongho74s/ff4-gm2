...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  latLongToggles->addItem(new CValueControl("TrafficStopDistanceAdjust", "LONG: TrafficStopDistance adjust(200)cm", "", "../assets/offroad/icon_logic.png", -1000, 1000, 10));
  ...
  latLongToggles->addItem(new CValueControl("JLeadFactor", "LONG: Jerk Lead Factor (0)", "x0.01", "../assets/offroad/icon_logic.png", 0, 100, 5));
